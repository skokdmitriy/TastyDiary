...
struct UIKitButtonTertiary: UIKitButtonType {
	var `default`: UIKitButtonAppearance = UIKitButtonTertiaryDefault()
	var enabler: UIKitButtonAppearance = UIKitButtonTertiaryEnabled()
	var pressed: UIKitButtonAppearance = UIKitButtonTertiaryPressed()
	var disable: UIKitButtonAppearance = UIKitButtonTertiaryDisabled()
}
